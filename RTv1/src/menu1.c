...
/*   Updated: 2016/05/31 20:41:48 by fhenri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_suite2(t_tool *t)
{
	...
	mlx_put_image_to_window(t->mlx_ptr, t->m->mlx_win,
	mlx_xpm_file_to_image(t->mlx_ptr, ft_strdup("miniature/not-found.xpm"),
...
void	print_suite1(t_tool *t)
{
	...
	mlx_put_image_to_window(t->mlx_ptr, t->m->mlx_win,
	mlx_xpm_file_to_image(t->mlx_ptr, ft_strdup("miniature/jungle.xpm"),
...
void	print_suite(t_tool *t)
{
	...
	mlx_put_image_to_window(t->mlx_ptr, t->m->mlx_win,
	mlx_xpm_file_to_image(t->mlx_ptr, ft_strdup("miniature/new.xpm"),
